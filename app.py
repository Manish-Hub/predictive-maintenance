...
# Inputs
engine_rpm = st.number_input("Engine RPM", min_value=500, max_value=10000, value=1200)
lub_oil_pressure = st.number_input("Lub Oil Pressure", min_value=0.5, max_value=20.0, value=1.5)
fuel_pressure = st.number_input("Fuel Pressure", min_value=100, max_value=2000, value=210)
coolant_pressure = st.number_input("Coolant Pressure", min_value=0.5, max_value=20.0, value=1.4)
lub_oil_temp = st.number_input("Lub Oil Temp (°C)", min_value=60, max_value=4200, value=95)
coolant_temp = st.number_input("Coolant Temp (°C)", min_value=60, max_value=4200, value=85)
